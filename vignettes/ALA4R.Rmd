...
%\VignetteDepends{knitr,plyr,jpeg,phytools,ape,leafletR,vegan,mgcv,geosphere,maps,mapdata,maptools} \\
-->
...
```{r}
s=lapply(tx$scientificName,function(z){ species_info(scientificname = z) })
```
...
imfiles=sapply(s,function(z){ 
  ifelse(any(grepl("(\\.jpg)",z$images$smallImageUrl,ignore.case=TRUE)),
         ALA4R:::cached_get(z$images$smallImageUrl[grepl("(\\.jpg)",z$images$smallImageUrl, ignore.case=TRUE)][1],type="binary_filename"),
         "") 
})
```
